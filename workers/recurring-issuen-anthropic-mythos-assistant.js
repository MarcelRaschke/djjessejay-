const MYTHOS = {
  issue: "M10-86",
  name: "Recurring Issuen Anthropic Mythos Assistant",
...
function createAssistantReply(prompt) {
  const seed = prompt || "Recurring Issuen Anthropic Mythos";
  return [
    `Ich halte den wiederkehrenden Raum für: ${seed}`,
    "Recurring-Issuen-Mythos: erst zuhören, dann strukturieren, dann menschlich finalisieren.",
