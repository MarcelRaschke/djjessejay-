const MYTHOS = {
  issue: "M10-72",
  name: "Recurring Anthropic Mythos Assistant",
...
function createAssistantReply(prompt) {
  const seed = prompt || "Recurring Anthropic Mythos";
  return [
    `Ich halte den wiederkehrenden Raum für: ${seed}`,
    "Recurring Mythos: erst zuhören, dann strukturieren, dann menschlich finalisieren.",
