#!/usr/bin/env python3
"""Smoke checks for the M10-86 Recurring Issuen · Anthropic Mythos static page."""
from html.parser import HTMLParser
from pathlib import Path

ROOT = Path(__file__).resolve().parents[1]
PAGE = ROOT / "recurring-issuen-anthropic-mythos.html"
README = ROOT / "README.md"
WORKER = ROOT / "workers" / "recurring-issuen-anthropic-mythos-assistant.js"

REQUIRED_PAGE_SNIPPETS = [
    "M10-86 · Recurring Issuen · Anthropic Mythos · IP Codex",
    "Recurring-Issuen-Mythos für eine KI-Muse mit Gewissen.",
    "IP-Codex",
    "Debug-Manifest",
    "Worker-Assistent",
]
...
REQUIRED_WORKER_SNIPPETS = [
    "Recurring Issuen Anthropic Mythos Assistant",
    "GET /health",
    "POST /assist",
    "export default",
]
...
def main():
    ...
    print("M10-86 recurring Issuen smoke checks passed")
