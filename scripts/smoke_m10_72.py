#!/usr/bin/env python3
"""Smoke checks for the M10-72 Recurring Anthropic Mythos static page."""
from html.parser import HTMLParser
from pathlib import Path

ROOT = Path(__file__).resolve().parents[1]
PAGE = ROOT / "recurring-anthropic-mythos.html"
README = ROOT / "README.md"
WORKER = ROOT / "workers" / "recurring-anthropic-mythos-assistant.js"

REQUIRED_PAGE_SNIPPETS = [
    "M10-72 · Recurring Anthropic Mythos · IP Codex",
    "Recurring Mythos für eine KI-Muse mit Gewissen.",
    "IP-Codex",
    "Debug-Manifest",
    "Worker-Assistent",
]
...
REQUIRED_WORKER_SNIPPETS = [
    "Recurring Anthropic Mythos Assistant",
    "GET /health",
    "POST /assist",
    "export default",
]
...
def main():
    ...
    print("M10-72 recurring smoke checks passed")
